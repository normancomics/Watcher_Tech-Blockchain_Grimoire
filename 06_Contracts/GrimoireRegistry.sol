...
contract GrimoireRegistry {
    ...
    /**
     * @notice Get a knowledge entry by its ID
     * @dev Explicit getter that returns the full struct (including crossReferences array)
     */
    function getEntry(uint256 entryId) external view returns (KnowledgeEntry memory) {
